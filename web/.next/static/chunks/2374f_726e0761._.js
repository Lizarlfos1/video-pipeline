...
"[project]/web/node_modules/zundo/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        return {
            ...
            undo: function() {
                ...
                if (get().pastStates.length) {
                    var _options_partialize, _options_diff;
                    const currentState = (options === null || options === void 0 ? void 0 : (_options_partialize = options.partialize) === null || _options_partialize === void 0 ? void 0 : _options_partialize.call(options, userGet())) || userGet();
                    const statesToApply = get().pastStates.splice(-steps, steps);
                    const nextState = statesToApply.shift();
                    userSet(nextState);
                    set({
                        pastStates: get().pastStates,
                        futureStates: get().futureStates.concat((options === null || options === void 0 ? void 0 : (_options_diff = options.diff) === null || _options_diff === void 0 ? void 0 : _options_diff.call(options, currentState, nextState)) || currentState, statesToApply.reverse())
                    });
                }
            },
            redo: function() {
                ...
                if (get().futureStates.length) {
                    ...
                    userSet(nextState);
                    set({
                        pastStates: get().pastStates.concat((options === null || options === void 0 ? void 0 : (_options_diff = options.diff) === null || _options_diff === void 0 ? void 0 : _options_diff.call(options, currentState, nextState)) || currentState, statesToApply.reverse()),
            ...
            _handleSet: (pastState, replace, currentState, deltaState)=>{
                var _get__onSave, _get;
                if ((options === null || options === void 0 ? void 0 : options.limit) && get().pastStates.length >= (options === null || options === void 0 ? void 0 : options.limit)) {
                    get().pastStates.shift();
                }
                (_get__onSave = (_get = get())._onSave) === null || _get__onSave === void 0 ? void 0 : _get__onSave.call(_get, pastState, currentState);
                set({
...
var temporal = (config, options)=>{
    const configWithTemporal = (set, get, store)=>{
        var _options_wrapTemporal, _options_handleSet;
        store.temporal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$zustand$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStore"])((options === null || options === void 0 ? void 0 : (_options_wrapTemporal = options.wrapTemporal) === null || _options_wrapTemporal === void 0 ? void 0 : _options_wrapTemporal.call(options, temporalStateCreator(set, get, options))) || temporalStateCreator(set, get, options));
        const curriedHandleSet = (options === null || options === void 0 ? void 0 : (_options_handleSet = options.handleSet) === null || _options_handleSet === void 0 ? void 0 : _options_handleSet.call(options, store.temporal.getState()._handleSet)) || store.temporal.getState()._handleSet;
        const temporalHandleSet = (pastState)=>{
            var _options_partialize, _options_diff, // If the user has provided an equality function, use it
            _options_equality;
            if (!store.temporal.getState().isTracking) return;
            const currentState = (options === null || options === void 0 ? void 0 : (_options_partialize = options.partialize) === null || _options_partialize === void 0 ? void 0 : _options_partialize.call(options, get())) || get();
            const deltaState = options === null || options === void 0 ? void 0 : (_options_diff = options.diff) === null || _options_diff === void 0 ? void 0 : _options_diff.call(options, pastState, currentState);
            if (// Don't call handleSet if state hasn't changed, as determined by diff fn or equality fn
            !(deltaState === null || (options === null || options === void 0 ? void 0 : (_options_equality = options.equality) === null || _options_equality === void 0 ? void 0 : _options_equality.call(options, pastState, currentState)))) {
        ...
        store.setState = function() {
            ...
            var _options_partialize;
            const pastState = (options === null || options === void 0 ? void 0 : (_options_partialize = options.partialize) === null || _options_partialize === void 0 ? void 0 : _options_partialize.call(options, get())) || get();
            setState(...args);
...
//# sourceMappingURL=2374f_726e0761._.js.map